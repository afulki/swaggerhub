...
request_param_info('AddInventory', 'InventoryItem') ->
    #{
        source =>   body,
        rules => [
            schema,
...
request_param_info('SearchInventory', 'searchString') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'binary'},
...
request_param_info('SearchInventory', 'skip') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'integer'},
...
request_param_info('SearchInventory', 'limit') ->
    #{
        source => qs_val  ,
        rules => [
            {type, 'integer'},
...
validate_response('AddInventory', 201, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('AddInventory', 400, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
validate_response('AddInventory', 409, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);


validate_response('SearchInventory', 200, Body, ValidatorState) ->
    validate_response_body('list', 'QuoteUnion', Body, ValidatorState);
validate_response('SearchInventory', 400, Body, ValidatorState) ->
    validate_response_body('', '', Body, ValidatorState);
